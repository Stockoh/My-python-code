...
def verify_proofs(proof, version_chainpoint="1"):
    ...
    try:
        site = requests.get(
            f"https://www.blockchain.com/btc/tx/{tx_id}", timeout=3)
    except ConnectionError:
        return {"error": "network_error"}
    pattern = r'(<span class="sc-1ryi78w-0 cILyoi sc-16b9dsl-1 ZwupP u3ufsr-0'
    pattern += r' eQTRKC" opacity="1">)([a-f0-9]{64})(</span>)'
    pattern = re.compile()
